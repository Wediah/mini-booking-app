<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Create your booking</h2>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form wire:submit="book" class="space-y-6">
            <div>
                ...
                <div class="mt-2">
                    <textarea id="purpose" wire:model="purpose" type="text" autocomplete="purpose" required
                           class="block
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="password" wire:model="date" type="date"
            ...
            <div>
                ...
                focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Book</button>
            </div>
        </form>
    </div>
</div>
